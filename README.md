...
## About
This is an app for managing your finances I created this app for my mother Malu Pontes, you can control many accounts and transfer money between them, so it can be used for domestical purposes but also for a big institution.
